    ...
    <div className="space-y-8">
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
          <IconHelpCircle className="w-6 h-6 text-blue-500" />
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-100">Voice Commands</h3>
        </div>
        <div className="space-y-6 pl-10">
          <div>
            <h4 className="font-semibold text-gray-100 mb-3 text-lg">Navigation</h4>
            <ul className="text-base text-gray-100 space-y-2 leading-relaxed">
          ...
          <div>
            <h4 className="font-semibold text-gray-100 mb-3 text-lg">Text Input</h4>
            <ul className="text-base text-gray-100 space-y-2 leading-relaxed">
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-100">Safety Features</h3>
        </div>
        <div className="space-y-4 pl-10">
          <p className="text-base text-gray-100 leading-relaxed">
      ...
      <section>
        ...
        <div className="space-y-3 pl-10">
          ...
          <div className="flex justify-between items-center">
            <span className="text-base text-gray-100 leading-relaxed">Stop Current Action</span>
            <kbd className="px-3 py-1.5 text-sm font-semibold text-gray-100 bg-gray-800 border border-gray-700 rounded-lg">
              Escape
            </kbd>
          </div>
      ...
      {/* Tips */}
      <section>
        <h3 className="text-xl font-semibold text-gray-100 mb-4">Tips for Best Results</h3>
        <div className="space-y-3 pl-10">
          <p className="text-base text-gray-100 leading-relaxed">• Speak clearly and at normal speed</p>
          <p className="text-base text-gray-100 leading-relaxed">• Use natural language - no special commands needed</p>
          <p className="text-base text-gray-100 leading-relaxed">• Be specific when describing buttons or elements</p>
          <p className="text-base text-gray-100 leading-relaxed">• If unsure, ask Steward to describe what's on screen</p>
        </div>
      </section>
    </div>
  )
